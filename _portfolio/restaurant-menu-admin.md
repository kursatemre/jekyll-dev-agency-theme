...
- **TypeScript**: Type-safe development (90.3%)
- **JavaScript**: Additional scripting (5.1%)
- **CSS**: Styling (1.4%)
- **HTML**: Markup (1.1%)

**Backend & Database:**
- **Supabase**: PostgreSQL database (2.1%)
...
- **JavaScript**: 5.1% (Runtime logic)
- **PLpgSQL**: 2.1% (Database functions)
- **CSS**: 1.4% (Styling)
- **HTML**: 1.1% (Markup)
...
1. **Testing**: Unit ve integration testleri
2. **Documentation**: API ve component dokümantasyonu
3. **i18n**: Multi-language support
4. **Performance**: Lighthouse score optimizasyonu
5. **Features**: Additional menu features
